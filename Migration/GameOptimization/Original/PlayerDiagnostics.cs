...
public sealed class PlayerDiagnostics : MonoBehaviour {
 ...
 IEnumerator Capture(){Application.runInBackground=true;yield return new WaitForSecondsRealtime(1);if(Array.IndexOf(Environment.GetCommandLineArgs(),"-emoji-battle")>=0&&EmojiGame.Instance!=null)EmojiGame.Instance.Evaluate("gameState=3;HandleCharSelectTouch(360,674)");yield return new WaitForSecondsRealtime(4);yield return new WaitForEndOfFrame();
